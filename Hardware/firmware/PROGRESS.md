...
>
> **Two candidates, and the discriminator is cheap** — lights on, beam on, scene genuinely
> static, three repeat captures. Reproducible → room-light switching harmonics near 104 kHz
> (⚠ the lock-in rejects 120 Hz, **not** ambient energy near the carrier). Wildly varying →
> motion in the beam, which is the detector working correctly. See the 8/21 rows in §6.
>
> ---
>
